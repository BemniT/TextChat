...
import com.example.babycare.databinding.ItemContainerRecievedMessageBinding;
import com.example.babycare.databinding.ItemContainerSentMessageBinding;
import com.example.babycare.models.ChatMessage;
...
public class ChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_TYPE_SENT){
            ...
            return new ReceivedMessageViewHolder(ItemContainerRecievedMessageBinding
    ...
    static class ReceivedMessageViewHolder extends RecyclerView.ViewHolder{
        ...
        void setData(ChatMessage chatMessage, Bitmap receiverProfileImage){
            binding.textMessage.setText(chatMessage.message);
            binding.textDateTime.setText(chatMessage.dateTime);
            binding.imageReceivedProfile.setImageBitmap(receiverProfileImage);
        }
    }
}
